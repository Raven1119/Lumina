...
class MagmaMemoryAdapter:
    def __init__(
        ...
        *,
        ...
        if not isinstance(associative_read_profile, str) or associative_read_profile not in {"first-hit-v1", "reliable-v1", "reliable-v2", "graph-read-v1", "graph-read-v2", "body-recall-v1", "calibrated-first-hit-v1", "semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4"}:
            raise ValueError("invalid_associative_read_profile")
        if associative_read_profile in {"reliable-v1", "reliable-v2", "graph-read-v1", "graph-read-v2", "body-recall-v1", "calibrated-first-hit-v1", "semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4"} and first_hit is None:
        ...
        if associative_read_profile in {"calibrated-first-hit-v1", "semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4"}:
    ...
    def ingest(self, segment: ColdDraftSegment) -> IngestionResult:
        if self.associative_read_profile in {"calibrated-first-hit-v1", "semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4"}:
            try:
    ...
    def _reliable_dispatch(
        ...
        """
        if self.associative_read_profile in {"semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4"}:
    ...
    def lock_semantic_base(self, prepared, suggestions, seek_graph, graph_intent):
        if self.associative_read_profile != "semantic-associative-v4":
