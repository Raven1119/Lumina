"""Stage-2 production Recall gate, promoted from the shadow-validated candidate.
...
class LlmMindGate:
    ...
    def decide(
        ...
        # v2: flatten context and message into a single classification prompt.
        # v1 passed context as native chat turns, which made the model answer
        # the message itself instead of classifying it (protocol failure on
        # all in-context-reference cases).
        context_text = "\n".join(
        ...
        return MindDecision(recall=_parse(raw))
