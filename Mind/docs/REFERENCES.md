...
| --- | --- |
| Kimi CLI | [86f136422a0aae6b217ea49e7ea1d2e8a1defcd2](https://github.com/MoonshotAI/kimi-cli/tree/86f136422a0aae6b217ea49e7ea1d2e8a1defcd2), Apache-2.0. Small compaction core and applicable tests adapted in `working_context.py`; no Kimi/Kosong runtime. [Pinned blobs, differences, full LICENSE and NOTICE](../../vendor/kimi_compaction/PROVENANCE.md). |
