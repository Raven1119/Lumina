...
_SEMANTIC_V3_RECALL_POLICY = RecallPolicy(
    top_k=10, max_graph_depth=1, max_nodes=20, max_evidence_items=40,
    max_chars=12000, max_bytes=48000, final_min_score=None,
    include_source_context=True,
)
_SEMANTIC_V4_RECALL_POLICY = _SEMANTIC_V2_RECALL_POLICY
...
def _default_semantic_selector(chat_model: ModelClient, *, version: int = 1):
    selector_type = (LlmSemanticEvidenceSelectorV7 if version == 7 else
                     LlmSemanticEvidenceSelectorV6 if version == 6 else
                     LlmSemanticEvidenceSelectorV5 if version == 5 else
...
def _build_memory_retriever(
    ...
    if memory_profile not in {"production", "body-recall-v1", "calibrated-first-hit-v1", "semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6", "semantic-associative-v7"}:
        raise ValueError("invalid_memory_profile")
    if memory_profile in {"semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6", "semantic-associative-v7"} and os.environ.get("LUMINA_MIND_GATE_MODE", "llm").strip().lower() != "llm":
    ...
    if formation_model is None and memory_profile in {"calibrated-first-hit-v1", "semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6", "semantic-associative-v7"}:
    ...
    read_profile = (memory_profile if memory_profile in {"calibrated-first-hit-v1", "semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6", "semantic-associative-v7"}
...
def create_app(
    *,
    ...
    semantic_mode = semantic_profile in {"semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6", "semantic-associative-v7"}
    ...
    effective_recall_policy = (
        ...
        else (_SEMANTIC_V4_RECALL_POLICY if semantic_profile in {"semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6", "semantic-associative-v7"}
    ...
    effective_semantic_selector = (
        semantic_selector if semantic_selector is not None
            ...
            effective_model, version=7 if semantic_profile == "semantic-associative-v7"
            else 6 if semantic_profile == "semantic-associative-v6"
            else 5 if semantic_profile == "semantic-associative-v5"
