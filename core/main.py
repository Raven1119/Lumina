...
def _default_semantic_selector(chat_model: ModelClient, *, version: int = 1):
    selector_type = (LlmSemanticEvidenceSelectorV6 if version == 6 else
...
def _build_memory_retriever(
    ...
    if memory_profile not in {"production", "body-recall-v1", "calibrated-first-hit-v1", "semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6"}:
        raise ValueError("invalid_memory_profile")
    if memory_profile in {"semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6"} and os.environ.get("LUMINA_MIND_GATE_MODE", "llm").strip().lower() != "llm":
    ...
    if formation_model is None and memory_profile in {"calibrated-first-hit-v1", "semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6"}:
    ...
    read_profile = (memory_profile if memory_profile in {"calibrated-first-hit-v1", "semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6"}
...
def create_app(
    *,
    ...
    semantic_mode = semantic_profile in {"semantic-associative-v1", "semantic-associative-v2", "semantic-associative-v3", "semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6"}
    ...
    effective_recall_policy = (
        ...
        else (_SEMANTIC_V4_RECALL_POLICY if semantic_profile in {"semantic-associative-v4", "semantic-associative-v5", "semantic-associative-v6"}
    ...
    effective_semantic_selector = (
        semantic_selector if semantic_selector is not None
            ...
            effective_model, version=6 if semantic_profile == "semantic-associative-v6"
